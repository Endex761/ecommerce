  ...
  <body>
    ...
    <section >
      <div class="container-fluid col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <form  class="" method="post" name="signup-form" id="signup" action="home.php">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-sm" id="nome" autocomplete="off" required>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-sm" id="cognome" autocomplete="off" required>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group contact-field">
                    ...
                    <input  type="password"  class="form-control input-sm" id="password" placeholder="Almeno 8 caratteri" minlength="8" maxlength="16" autocomplete="off" required>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="password" class="form-control input-sm" id="conferma-password" oninput="checkPassword(this);" maxlength="16" autocomplete="off" required>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-sm" id="risposta-recupero-psw" placeholder="Qual è il cognome da nubile di tua madre?" autocomplete="off" required>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-sm" id="indirizzo" autocomplete="off" required>
                </div>
            </div>
